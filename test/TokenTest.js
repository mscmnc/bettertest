...
contract('BetterToken', function(accounts) {
  it("should put 1000000 BetterToken in the first account", function() {
    return BetterToken.deployed().then(function(instance) {
