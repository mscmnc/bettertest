...
import chainlist_artifacts from '../../build/contracts/ChainList.json'
import bettertoken_artifacts from '../../build/contracts/BetterToken.json'

// MetaCoin is our usable abstraction, which we'll use through the code below.
var ChainListContract = contract(chainlist_artifacts);
var BetterTokenContract = contract(bettertoken_artifacts);
...
window.App = {
  start: function() {
    ...
    ChainListContract.setProvider(web3.currentProvider);
    BetterTokenContract.setProvider(web3.currentProvider);
